...
new SpringCloudAppStarterStarterMavenPluginsBuildMaker(dsl, "spring-cloud", "spring-cloud-app-starters-maven-plugins", "spring-cloud-stream-app-maven-plugin").deploy(true, true)
