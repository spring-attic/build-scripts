...
new SpringCloudStreamBuildMarker(dsl, "sobychacko", "spring-cloud-stream-binder-rabbit", "ci-build-rabbbit-docker", [:]).deploy(true, false, "clean deploy -U", "docker-compose-RABBITMQ.sh")
