...
class AllScstAppStarterJobs {
    ...
    public static final List<String> PHASE2_JOBS = ['loggregator', 'load-generator', 'mail', 'field-value-counter',
    ...
    public static final List<String> PHASE3_JOBS = ['syslog', 'filter', 'splitter', 'jms', 'groovy-filter',
                                                    'redis-pubsub', 'aggregate-counter', 'tcp', 'httpclient']
...
//
//    public static final List<String> PHASE2_JOBS = ['load-generator', 'mail', 'field-value-counter',
...
//                                                    'httpclient', 'twitter', 'counter', 'mqtt', 'aggregator']
//
//    public static final List<String> PHASE4_JOBS = ['rabbit', 'gemfire', 'scriptable-transform', 'ftp', 'file', 'aws-s3', 'sftp',
