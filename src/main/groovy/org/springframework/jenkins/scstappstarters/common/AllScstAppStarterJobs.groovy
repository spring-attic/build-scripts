...
class AllScstAppStarterJobs {
    ...
    public static final Map<String, String> RELEASE_PHASE0_JOBS = ['log':'1.3.0.M1', 'time':'1.3.0.M1']

    public static final Map<String, String> RELEASE_PHASE1_JOBS = ['throughput':'1.3.0.M1', 'bridge':'1.3.0.M1', 'groovy-transform':'1.3.0.M1', 'tasklauncher-local':'1.3.0.M1', 'transform':'1.3.0.M1', 'header-enricher':'1.3.0.M1']
