...
//                                                    'redis-pubsub', 'aggregate-counter', 'tcp',
//                                                    'tasklauncher-yarn', 'tasklauncher-cloudfoundry', 'tasklauncher-kubernetes',
//                                                    'httpclient', 'twitter', 'counter', 'aggregator']
//
//    public static final List<String> PHASE4_JOBS = ['mqtt', 'rabbit', 'gemfire', 'scriptable-transform', 'ftp', 'file', 'aws-s3', 'sftp',
//                                                    'tensorflow', 'mongodb', 'hdfs', 'jdbc', 'python']
//
//    public static final List<String> ALL_JOBS =
//            PHASE1_JOBS + PHASE2_JOBS +
