...
class AllScstAppStarterJobs {
   ...
   // public static final List<String> PHASE1_JOBS = ['log', 'time', 'ftp', 'sftp', 'file']
    ...
    public static final Map<String, String> RELEASE_PHASE4_JOBS = ['counter':'1.1.2.M1', 'aggregate-counter':'1.1.2.M1', 'field-value-counter':'1.1.2.M1', 'bridge':'1.1.2.M1', 'gpfdist':'1.1.2.M1']

    public static final Map<String, String> RELEASE_PHASE5_JOBS = ['tasklauncher-local':'1.1.2.M1', 'tasklauncher-yarn':'1.1.2.M1', 'tasklauncher-cloudfoundry':'1.1.0.RC2', 'throughput':'1.1.2.M1', 'aws-s3':'1.1.2.M1']

    public static final Map<String, String> RELEASE_PHASE6_JOBS = ['filter':'1.1.2.M1', 'groovy-filter':'1.1.2.M1', 'groovy-transform':'1.1.2.M1', 'httpclient':'1.1.2.M1', 'aggregator':'1.0.0.M1']

    public static final Map<String, String> RELEASE_PHASE7_JOBS = ['load-generator':'1.1.2.M1', 'loggregator':'1.1.2.M1', 'mail':'1.1.2.M1', 'mongodb':'1.1.2.M1', 'pmml':'1.1.2.M1']

    public static final Map<String, String> RELEASE_PHASE8_JOBS = ['redis-pubsub':'1.1.2.M1', 'scriptable-transform':'1.1.2.M1', 'splitter':'1.1.2.M1', 'syslog':'1.1.2.M1', 'tcp':'1.1.2.M1']
