...
class AllCloudJobs {
	...
	public static final List<String> ALL_JOBS = ['spring-cloud-sleuth', 'spring-cloud-netflix', 'spring-cloud-zookeeper', 'spring-cloud-consul',
												 ...
												 'spring-cloud-cli', 'spring-cloud-contract', 'spring-cloud-vault-config']
	/**
	 ...
	 * for more info.
	 */
	public static final List<String> CUSTOM_BUILD_JOBS = ['spring-cloud-consul', 'spring-cloud-build', 'spring-cloud-contract', 'spring-cloud-vault-config']
